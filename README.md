...
This repository is set up as a *monorepo*, the frontend and backend projects are in one repository. This allows you to open both projects in the same editor.

Writing code that allows your frontend and backend applications to talk to each other. Write code to allow your controllers and services to connect to, and query, your PostgreSQL database via [Knex](http://knexjs.org/).
